...
const Profile = () => {
    ...
    const tokenExpiration = parseInt(
        localStorage.getItem("auth_token_expiration"),
        10
    );
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            await axios.post(
                `http://localhost:8000/api/change-password/${user_id}`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${authToken}`,
        ...
        <div>
            ...
            <section className="mt-0 mx-auto ">
                <div className="w-1/2 mx-auto flex gap-0">
                    <div className="w-1/2 mx-auto shadow-2xl mt-16 bg-gray-200 absolute top-10  p-6 rounded-xl h-fit self-center dark:bg-gray-800/40">
                        <div>
                            <h1 className="lg:text-2xl md:text-xl sm:text-xl xs:text-lg  font-extrabold mb-2 dark:text-white">
                                Profile
                            </h1>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex space-x-2">
                                    <button
                                        type="button"
                                        className={`text-lg rounded-md font-medium text-white w-20 h-10 primary-btn
                                            ${isEditing ? "bg-red-600" : "bg-blue-color"}`}
                                    ...
                                    {isEditing && (
                                        <button
                                            type="submit"
                                            className="text-lg bg-blue-color w-20 h-10 rounded-md font-medium text-blue-600 text-white "
                            ...
                            >
                                ...
                                <label htmlFor="mobile" className="font-medium text-md">
                                    Mobile
                                    <input
                                        autoComplete="off"
                                        type="text"
                            ...
                            <button
                                type="button"
                                className={`text-sm rounded-md font-medium text-white w-40 h-10 primary-btn`}
                                onClick={() => setShowPopup(true)}
                            >
                                Change Password
                            </button>
                            {showPopup && (
                                <div className="fixed bg-opacity-45 shadow-2xl bg-transparent bg-gray-900 inset-0 flex items-center justify-center">
