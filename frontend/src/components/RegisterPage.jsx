...
const Register = () => {
    ...
    const success = () => {
        Modal.success({
            content: "You have Registred successfully",
        })
    }
    ...
    const hashUpperCase = /[A-Z]/.test(formData.password);
    const hashNumber = /[0-9]/.test(formData.password);
    ...
    return (
        ...
        >
            ...
            <div className="main flex flex-grow items-center justify-center">
                <div className="bg-gray-100 mt-20 mb-0 rounded-md max-w-3xl flex">
                    <div className="w-1/2 flex items-center justify-between">
                        <img className="w-full h-auto" src={img} alt="house" />
                    </div>
                    <div className="w-1/2 flex items-center justify-center">
                        <div className="p-4 rounded w-full max-w-md">
                            ...
                            <form onSubmit={handleSubmit} autoComplete="off">
                                ...
                                <div className="mb-3">
                                    ...
                                    <input
                                        type="text"
                                        className={`mt-1 block w-full p-1 border ${errors.name
                                                ? "border-red-500"
                                                : "border-gray-300"
                                            } rounded-md`}
                                        name="name"
                                ...
                                <div className="mb-3">
                                    ...
                                    <input
                                        type="email"
                                        className={`mt-1 block w-full p-1 border ${errors.email
                                                ? "border-red-500"
                                                : "border-gray-300"
                                            } rounded-md`}
                                        name="email"
                                ...
                                <fieldset className="mb-3 flex items-center gap-4">
                                    ...
                                    <div className="">
                                        <label className="inline-flex items-center">
                                            <input
                                                type="radio"
                                                className={`form-radio ${errors.gender
                                                        ? "text-red-500"
                                                        : ""
                                                    }`}
                                                name="gender"
                                ...
                                <div className="mb-3">
                                    ...
                                    <input
                                        type="text"
                                        className={`mt-1 block w-full p-1 border ${errors.mobile
                                                ? "border-red-500"
                                                : "border-gray-300"
                                            } rounded-md`}
                                        name="mobile"
                                ...
                                <div className="mb-3 relative">
                                    ...
                                    <input
                                        type={showPassword ? "text" : "password"}
                                        className={`mt-1 block w-full p-1 border ${errors.password
                                                ? "border-red-500"
                                                : "border-gray-300"
                                            } rounded-md`}
                                        name="password"
                                    ...
                                    {isTooltipOpen && errors.password && (
                                        ...
                                        >
                                            <div>
                                                <span className="text-white">Password must Contain:</span>
                                                <span
                                                    className={`flex items-center ${passwordLength
                                                            ? "text-green-500"
                                                            : "text-red-500"
                                                        }`}
                                                >
                                                ...
                                                <span
                                                    className={`flex items-center ${hashUpperCase
                                                            ? "text-green-500"
                                                            : "text-red-500"
                                                        }`}
                                                >
                                                ...
                                                <span
                                                    className={`flex items-center ${hashNumber
                                                            ? "text-green-500"
                                                            : "text-red-500"
                                                        }`}
                                                >
                                                ...
                                                <span
                                                    className={`flex items-center ${specialChar
                                                            ? "text-green-500"
                                                            : "text-red-500"
                                                        }`}
                                                >
                                ...
                                <div className="mb-3 relative">
                                    ...
                                    <input
                                        ...
                                        className={`mt-1 block w-full p-1 border ${errors.password_confirmation
                                                ? "border-red-500"
                                                : "border-gray-300"
                                            } rounded-md`}
                                        name="password_confirmation"
                                ...
                                <button
                                    type="submit"
                                    className="flex justify-center items-center px-4 py-2 mt-4 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                >
                                    Register
                                </button>
