                        ...
                        ads.rooms.map((ad) => (
                            <Card key={ad.id} className="w-full mb-4" style={{ fontFamily: 'Varela Round, sans-serif' }} onClick={() => showChildrenDrawer(ad)}>
                                <div className="flex flex-wrap justify-between">
                                    ...
                                    <h3 className="text-base font-bold">Price: <span className="font-normal">&#x20B9;{ad.price}</span></h3>
                                    <h3 className="text-base font-bold">Room Type: <span className="font-normal">{ad.room_type}</span></h3>
                                    <h3 className="text-base font-bold">Type: <span className="font-normal">{ad.listing_type}</span></h3>
                                </div>
                            </Card>
                        ))
                    )}
                        ...
                        ads.pg_listings.map((ad) => (
                            <Card key={ad.id} className="w-full mb-4" style={{ fontFamily: 'Varela Round, sans-serif' }} onClick={() => showChildrenDrawer(ad)}>
                                <div className="flex flex-wrap justify-between">
                                    ...
                                    <h3 className="text-base font-bold">Room Type: <span className="font-normal">{ad.pg_type}</span> </h3>
                                    <h3 className="text-base font-bold">Type: <span className="font-normal">{ad.listing_type}</span></h3>
                                </div>
                            </Card>
                        ))
